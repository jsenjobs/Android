...
exports.default = {
  ...
  mounted: function mounted() {
    ...
    PlatformTools.getItem('userKey', function (result) {
      if (result.result === 'success' && result.data) _this.openid = result.data;
    });
    PlatformTools.getItem('name', function (result) {
      if (result.result === 'success' && result.data) _this.name = result.data;
    });
    PlatformTools.getItem('address', function (result) {
      if (result.result === 'success' && result.data) _this.address = result.data;
    });
  }
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
  ...
  }, [_vm._v("手机号码：" + _vm._s(_vm.openid))]), _c('div', {
    staticClass: ["v-h"]
  })]), _c('div', {
    staticClass: ["row"]
  }, [_c('div', {
    ...
    staticClass: ["text-info"]
  }, [_vm._v("用户名字：" + _vm._s(_vm.name))]), _c('div', {
    staticClass: ["v-h"]
  })]), _c('div', {
    staticClass: ["row"]
  }, [_c('div', {
    ...
    staticClass: ["text-info", "text-address"]
  ...
  return _c('div', {
    ...
    staticClass: ["text-info", "text-mail"]
  }, [_vm._v("联系电话：17682490309")]), _c('div', {
    staticClass: ["v-h"]
  })])
...
__vue_options__.__file = "/Users/jsen/Documents/GitProjects/POJ/DeliverWater/Weex/DeliverWaterWeex/src/pages/me.vue"
__vue_options__.render = __vue_template__.render
__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
__vue_options__._scopeId = "data-v-d257ec14"
